...
class TerminatorRoboCop : public SeeingRobot, public MovingRobot, public SteppingRobot, public ShootingRobot 
{
    ...
    public:
        ...
        void move(Robot** robots, Battlefield &Test) 
        {
            cout << "TerminatorRobotCop" << getName() << " Just Moving As No Robot To Step~" << endl ;
...
void upgrade1(Robot** robotList, int numRobots) {
    for (int i = 0; i < numRobots; ++i) {
        if (robotList[i]->ableToUpgrade()) {
            cout << robotList[i]->getName() << " is upgrading to Terminator!" << endl;

            // Create a new Terminator object
            Terminator* terminator = new Terminator(robotList[i]->getName(), robotList[i]->getPos_X(), robotList[i]->getPos_Y());
            ...
            cout << "Terminator Replace RobotCop Sucess~" << endl;
        }
    }
}
...
int main() 
{
    ...
    */
    ...
    for (int j = 0; j < 5; j++) 
    {
        ...
        upgrade1(robotList, numRobots);
        cout << "Upgrade " << endl;
        Test.updatePos(robotList[numRobots]);   // Problem Here
        cout << "Upgrade Pos Done " << endl;
        Test.display(robotList, numRobots);
