    ...
    public:
        ...
        void move(Robot** robots, Battlefield &Test) {
            ...
            if((Test.getcol() - 1 == getPos_X() && Test.getrow() - 1 == getPos_Y()) || (getPos_X() == 0 && Test.getrow() - 1 == getPos_Y()) || (Test.getcol() - 1 == getPos_X() && getPos_Y() == 0) || (getPos_X() == 0 && getPos_Y() == 0))
            {
                ...
                if(counter == 4)
                {
                    cout << "TerminatorRoboCop" << getName() << " Cant Move As No Empty Space Surrounding !" << endl ;
                    return;
                }
            }
            else if(Test.getcol() - 1 == getPos_X() || Test.getrow() - 1 == getPos_Y() || getPos_X() == 0 || getPos_Y() == 0)
            ...
            cout << "move TerminatorRoboCop " << getName() << endl;
            bool existBot = true;
            int moveTo_X = -1;
            int moveTo_Y = -1;
...
public:
    ...
    void move(Robot** robots, Battlefield &Test) {
            ...
            if((Test.getcol() - 1 == getPos_X() && Test.getrow() - 1 == getPos_Y()) || (getPos_X() == 0 && Test.getrow() - 1 == getPos_Y()) || (Test.getcol() - 1 == getPos_X() && getPos_Y() == 0) || (getPos_X() == 0 && getPos_Y() == 0))
            {
                ...
                if(counter == 4)
                {
                    cout << "UltimateRobot" << getName() << " Cant Move As No Empty Space Surrounding !" << endl ;
                    return;
                }
            }
            else if(Test.getcol() - 1 == getPos_X() || Test.getrow() - 1 == getPos_Y() || getPos_X() == 0 || getPos_Y() == 0)
            ...
            cout << "move UltimateRobot " << getName() << endl;
            bool existBot = true;
            int moveTo_X = -1;
            int moveTo_Y = -1;
